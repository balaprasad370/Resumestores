...
while ($contactrow = mysqli_fetch_assoc($contactimplement)) {
  $contactdata .= "<div style='width:100%;padding-left:20px;height:100px;font-size:24px;line-height:39px;padding-top:10px;color:{$tempcolor};'>
   <h2 style='font-size:36px;margin-bottom:0;'>{$contactrow['firstname']} {$contactrow['lastname']}</h2> <span style='font-size:{$font_size_header};'>{$contactrow['profession']}</span></div>";
