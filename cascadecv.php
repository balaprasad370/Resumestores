...
$splitsides = "<div style='width:100%;'>
      <div style='float:right;width:70%;height:100%;font-size:{$font_size};padding-top:30px;margin-right:25px;'>{$summary}{$workheader} {$experience} {$schoolheader} {$education}  {$certificationheader} {$certification}  {$accomplishheader} {$accomplishment} {$interestheader}{$interests}{$yourheader} {$yourown} </div>

      <div style='float:left;width:26%;height:100%;font-size:{$font_size};background-color: #003D73;'> {$contactdata}{$contactheader}{$personal} {$skillheader} {$skill} {$softwareheader} {$software}<br> {$languageheader} {$language}  <br> <br>  </div>
      </div>";
