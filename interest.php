...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
  if(isset($_POST['sub'])){
    ...
    $skills = $_POST['skillname'];
        ...
        $update = "UPDATE interest set interestname='$skillimp' where sessionid='123456789';";
      ...
      $update = "UPDATE interest set interestname='' where sessionid='123456789';";
        $result = mysqli_query($conn,$update);
...
<section class="sect">
  <h1>What software skills do you have?</h1>
...
function fetch(){
   ...
   <?php
   $fet = "SELECT * from interest where sessionid='123456789';";
   $fetchresult = mysqli_query($conn,$fet);
   while($row = mysqli_fetch_array($fetchresult)){
       $skill1 = $row['interestname'];
