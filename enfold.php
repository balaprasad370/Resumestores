...
<path fill='#ffffff'  d='M3.612 15.443c-.386.198-.824-.149-.746-.592l.83-4.73L.173 6.765c-.329-.314-.158-.888.283-.95l4.898-.696L7.538.792c.197-.39.73-.39.927 0l2.184 4.327 4.898.696c.441.062.612.636.282.95l-3.522 3.356.83 4.73c.078.443-.36.79-.746.592L8 13.187l-4.389 2.256z'/>
</svg>";
...
while ($contactrow = mysqli_fetch_assoc($contactimplement)) {
  $contactdata .= "<div style='width:100%;font-size:18px;padding-top:10px;background:transparent;color:#fff;padding-left:20px;'>
   <h2 style='font-size:24px;margin-bottom:5px;'><strong>{$contactrow['firstname']} {$contactrow['lastname']}</strong></h2> <span>{$contactrow['profession']}</span></div>";
...
$contactheader = "<div style='margin:5px 0;padding:5px 0 5px 20px;color:#ffffff;font-size:{$font_size_header};background:#041b30;'><strong>Personal</strong></div>";

  $personal .= "<div style='padding-left:20px;color:#fff;'>
...
// $skillheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$skillheader = "<div style='margin-bottom:5px;padding:5px 0 5px 20px;font-size:{$font_size_header};color:#fff;background:#041b30;' ><strong>Skills</strong></div>";

for ($i = 0; $i < $skillcount; $i++) {
  $skill .= "<p style='line-height:0.5;margin-top:0;color:#fff;padding-left:20px;'>{$skillexp[$i]}</p>";
}
...
// $workheader = "<div style='padding:0 0 0 20px;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$workheader = "<div style='margin-bottom:5px;padding:5px 0 5px 20px;font-size:{$font_size_header};border-bottom: 1px solid #d5d6d6;border-top: 1px solid #d5d6d6;' class='header'><strong>Work History</strong></div>";
...
// education implement
// $schoolheader = "<div style='padding:0 0 0 20px;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$schoolheader = "<div style='margin-bottom:5px;padding:5px 0 5px 20px;font-size:{$font_size_header};border-bottom: 1px solid #d5d6d6;
border-top: 1px solid #d5d6d6;' class='header'><strong>Education</strong></div>";
...
for ($j = 0; $j < $schoolnorows; $j++) {
  ...
  $education .= "<div style='width:100%;'>
                                       ...
                                       <p style='margin:3px 0 0 0 ;'>{$schooldescription}</p>
...
// $softwareheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$softwareheader = "<div style='margin-bottom:5px;font-size:{$font_size_header};color:#fff;background:#041b30;padding:5px 0 5px 20px;' ><strong>Software</strong></div>";

for ($soft = 0; $soft < $softwarecount; $soft++) {
  $software .= "<p style='padding-left:20px;margin:0;color:#fff;'>{$softwareexp[$soft]}</p>";
}
...
// $languageheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$languageheader = "<div style='padding:5px 0 5px 20px;font-size:{$font_size_header};color:#d3d3d3;background:#041b30;' ><strong>Languages</strong></div>";
...
for ($lang = 0; $lang < $languagecount; $lang++) {
  ...
  $language .= "<p style='margin:0;color:#fff;padding-left:20px;margin-bottom:5px;'>{$languageexp[$lang]}</p><p style='float:right;margin:0 0 0 20px ;'>{$langstararray[$lang]}</p>";
}
...
//certification
// $certificationheader = "<div style='padding:0 0 0 20px;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$certificationheader = "<div class='header' style='padding:5px 0 5px 20px;margin-bottom:5px;font-size:{$font_size_header};border-bottom: 1px solid #d5d6d6;
border-top: 1px solid #d5d6d6;'><strong>Certifications</strong></div>";
...
$accomplishheader = "<div style='padding:5px 0 5px 20px;margin-bottom:5px;font-size:{$font_size_header};border-bottom: 1px solid #d5d6d6;
border-top: 1px solid #d5d6d6;' class='header'><strong>Accomplishments</strong></div>";
...
// //interest header
// $interestheader = "<div style='padding:0 0 0 20px;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$interestheader = "<div style='padding:5px 0 5px 20px;margin-bottom:5px;font-size:{$font_size_header};border-bottom: 1px solid #d5d6d6;
border-top: 1px solid #d5d6d6;' class='header'><strong>Interests</strong></div>";
...
for ($inte = 0; $inte < $interestcount; $inte++) {
  $interestex  .=   "<div style='margin-left:17%;'>" . $interestexp[$inte] . "</div>";
}

$interests = "<div style='margin-bottom:5px;'>{$interestex}</div>";
...
//Add your own
// $yourheader = "<div style='padding:0 0 0 20px;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 42 42'>
// <rect x='0' y='0' height='42' width='42' fill='{$font_icon_color}'></rect>
...
$yourheader = "<div style='padding:5px 0 5px 20px;margin-left:10px;font-size:{$font_size_header};border-bottom: 1px solid #d5d6d6;
border-top: 1px solid #d5d6d6;margin-bottom:5px;' class='header'><strong>Your Own</strong></div>";
...
$yourown = "<div style='margin-left:17%;'>{$yourown1}</div>";
...
$splitsides = "<div style='width:100%;'>
      <div style='float:left;width:70%;height:100%;font-size:{$font_size};padding-top:30px;margin-right:25px;'>{$summary}{$workheader} {$experience} {$schoolheader} {$education}  {$certificationheader} {$certification}  {$accomplishheader} {$accomplishment} {$interestheader}{$interests}{$yourheader} {$yourown} </div>

      <div style='float:right;width:26%;height:100%;font-size:{$font_size};background-color: #003D73;'> {$contactdata}{$contactheader}{$personal} {$skillheader} {$skill} {$softwareheader} {$software}<br> {$languageheader} {$language}  <br> <br>  </div>
      </div>";
