...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
  if(isset($_POST['sub'])){
        ...
        $updatetrue = "UPDATE certification set certname='$skillimp', certdate= '$starimp' where sessionid='123456789';";
        $resulttrue = mysqli_query($conn,$updatetrue);
        }
        else{
          $updatefalse = "UPDATE certification set certname=NULL, certdate= '' where sessionid='123456789';";
...
<section class="sect">
  <h1>What certififcations do you have?</h1>
...
function fetch(){
   ...
   <?php
   $fet = "SELECT * from certification where sessionid='123456789';";
...
?>
        ...
        <div class="row" style="margin-right: 10px;margin-top:30px;">
                        <div class="col-6">
                        <a href="addextra.php"><button type="button" class="btn btn-lg btn-info float-start">BACK</button></a>
                        </div>
                        <div class="col-6">
