...
$font_icon_color = '#252932';



//hr line 
$hr = "<hr style='margin-top:2px;width:90%;text-align:left;'>";
...
while ($contactrow = mysqli_fetch_assoc($contactimplement)) {
  $contactdata .= "<div style='width:100%;padding-left:20px;height:100px;font-size:24px;line-height:39px;padding-top:10px;' class='header'>
   ...
   $contactheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:5px;'><svg viewBox='0 0 54 54'>
   ...
   </svg></div><div style='height:30px;float:right;padding-top:5px;font-size:{$font_size_header};'><strong>Contact</strong></div></div>{$hr}";
...
$skillheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
$workheader = "<div style='padding:0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
// education implement
$schoolheader = "<div style='padding:0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
$softwareheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
$languageheader = "<div style='padding:0 0 0 0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
//certification
$certificationheader = "<div style='padding:0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
$accomplishheader = "<div style='padding:0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
//interest header
$interestheader = "<div style='padding:0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
//Add your own
$yourheader = "<div style='padding:0;width:100%;height: 30px;' class='header'><div style='width:30px;float:left;padding-right:10px;'><svg viewBox='0 0 54 54'>
<circle cx='27' cy='27' r='26'></circle>
...
$splitsides = "<div style='width:100%;'>
      <div style='float:right;width:72.8%;height:100%;font-size:{$font_size};margin:0;text-align:left;'>{$workheader} {$experience} {$schoolheader} {$education}  {$certificationheader} {$certification}  {$accomplishheader} {$accomplishment} {$interestheader}{$interests}{$yourheader} {$yourown} </div>

      <div style='float:left;width:25%;height:100%;padding-left:15px;font-size:{$font_size};'> {$contactheader}{$personal} {$skillheader} {$skill} {$softwareheader} {$software}<br> {$languageheader} {$language} {$pagenumber}  <br> <br>  </div>
      </div>";
