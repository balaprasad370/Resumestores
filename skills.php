...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (isset($_POST['sub'])) {
    ...
    $updatetrue = "UPDATE skills set skills='$skillimp',starskill = '$starimp' where sessionid='123456789';";
    $resulttrue = mysqli_query($conn, $updatetrue);
    }
    else{
      $updatefalse = "UPDATE skills set skills='',starskill = '' where sessionid='123456789';";
    ...
    <form action="skills.php" method="post">
      <div class="field_wrapper">
        ...
        <div>
          ...
          <a href="javascript:void(0);" class="add_button" title="Add field" style="color: #3A96F0;"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
